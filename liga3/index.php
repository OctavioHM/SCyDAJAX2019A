<?php
 ...
 if (isset($_SERVER['HTTP_X_REQUESTED_WITH'])) {
  ...
  HTML::cabeceras(array('title'      =>'EXAMEN DE LIGA 3 ',
			'description'=>'PAGINA SOBRE EL EXAMEN DE LIGA PHP',
 ...
 // Tabla con instancias
  ...
  $pie  = '<th colspan="@[numCols]">NUMERO DE USUARIOS: @[numReg]</th>';
		echo '<div id="divTabla" >';
  HTML::tabla($liga, 'USUARIOS CREADOS', $cols, true, $join, $pie);
		echo '</div>';
  ...
  $campos = array('*', '-fecha');
  HTML::forma($liga, 'CREAR NUEVO USUARIO', $campos, $props, true, $_POST);
  ...
  HTML::forma($liga, 'MODIFICAR USUARIOS ', $campos, $props, true);
 $cont = ob_get_clean();
